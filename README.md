...
DISCORD_TOKEN=...
VENICE_API_KEY=...
# Runtime defaults (override as needed)
VYXEN_SAFE_MODE_DEFAULT=0
VYXEN_TOOLS_ENABLED=1
VYXEN_TOOLS_DRY_RUN=0
VYXEN_TICK_INTERVAL=1.5
VYXEN_TICK_BUDGET_MS=1500
VYXEN_MAX_LLM_CALLS_PER_TICK=2
VYXEN_WATCHDOG_EVENT_LOOP_LAG=1.0
VYXEN_WATCHDOG_QUEUE_DEPTH=400
VYXEN_ADMIN_USERS=1245880674402172948,965371748059066398
```
